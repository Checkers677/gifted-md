**[PAIR CODE](Gifted~HFoURS4R#wtL0u72BAiVVZlcBtrkaznV3WhzcsvEcZoDjgx6kg1g)**

**[HEROKU DEPLOY URL](const { spawnSync, spawn } = require('child_process')
const { existsSync, writeFileSync } = require('fs')
const path = require('path')

const SESSION_ID = 'Gifted~HFoURS4R#wtL0u72BAiVVZlcBtrkaznV3WhzcsvEcZoDjgx6kg1g' // Edit this line only, don't remove ' <- this symbol
